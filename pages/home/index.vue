      ...
      <view class="page-content">
        ...
        <div class="page-item page-item1">
          <div class="charts-box">
            <RingCharts
              :wj_occupancy_rate="homeStatistic.wj_occupancy_rate"
              :occupancy_rate="homeStatistic.occupancy_rate"
              :company_num="homeStatistic.company_num"
              v-show="showCanvas"
            />
          </div>
...
import { statistic, article, rental, user,global } from "/utlis/https";
