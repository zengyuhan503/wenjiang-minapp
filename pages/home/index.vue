<template>
	<view class="page-body">
		<CustomNavbar ref="customNavBarRef" :onBack="goToOut" @changeOutModel="changeOutModel">
			<template #back>
				<image v-if="isLogin" src="https://louyutest.cdyunbu.com/wxapp/static/image/out.webp" mode="widthFix"
					class="back-icon" />
				<image style="width: 32px; height: 32px" v-else-if="isToLogin"
					src="https://louyutest.cdyunbu.com/wxapp/static/image/user.png" mode="widthFix" class="back-icon" />
			</template>
		</CustomNavbar>
		<view class="page-head" >
			<image src="https://louyutest.cdyunbu.com/wxapp/static/image/home-back.webp" mode="widthFix"></image>
		...
		<view class="page-main">
			<view class="page-content">
				<view class="page-item">
					<view class="data-items">
						<view class="data-item">
							...
							<view class="title">
								<image src="https://louyutest.cdyunbu.com/wxapp/static/image/data-icon.webp" mode="widthFix"></image>
								<text>总面积</text>
							</view>
						</view>
						<view class="data-item">
							...
							<view class="title">
								<image src="https://louyutest.cdyunbu.com/wxapp/static/image/data-icon2.webp" mode="widthFix"></image>
								<text>入驻率</text>
							</view>
						</view>
						...
						<view class="data-item">
							...
							<view class="title">
								<image src="https://louyutest.cdyunbu.com/wxapp/static/image/data-icon3.webp" mode="widthFix"></image>
								<text>已入驻面积</text>
							</view>
						</view>
						...
						<view class="data-item" @click="toLouyuList">
							...
							<view class="title hasLink">
								<view>
									<image src="https://louyutest.cdyunbu.com/wxapp/static/image/data-icon4.webp" mode="widthFix"></image>
									<text>楼宇总数</text>
								</view>
								<view class="link">
									详情
									<image src="https://louyutest.cdyunbu.com/wxapp/static/image/right.png" mode="widthFix"></image>
								</view>
							</view>
						</view>
					</view>
				...
				<view class="page-item page-item2">
					...
					<view class="items">
						<view class="item" @click="toLouyuInfo(item.id)" v-for="(item, index) in rentalList" :key="index">
							<view class="cover">
