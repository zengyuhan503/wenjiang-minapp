<template>
  <view class="page-container">
    ...
    <view class="menu-list">
      <view class="menu-item" @click="navTo('/pages/company/coupon-desc')">
      ...
      <view class="menu-item" @click="navTo('/pages/company/coupon-list')">
...
const companyName = ref("成都科大讯飞教育股份有限公司");
...
onShow(() => {
  ...
  user.getInfo().then(res => {
    if (res.code === 200 && res.data && res.data.company && res.data.company.property1) {
      // 假设 property1 是公司名称
      companyName.value = res.data.company.property1;
    }
  });
});
</script>
